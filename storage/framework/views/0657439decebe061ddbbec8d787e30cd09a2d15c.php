...
@font-face {
  ...
  src: url('<?php echo e(storage_path("fonts/Avenir-Roman.eot")); ?>') format("embedded-opentype"), url('<?php echo e(storage_path("fonts/Avenir-Roman.woff2")); ?>') format("woff2"), url('<?php echo e(storage_path("fonts/Avenir-Roman.woff")); ?>') format("woff"), url('<?php echo e(storage_path("fonts/Avenir-Roman.ttf")); ?>') format("truetype"), url('<?php echo e(storage_path("fonts/Avenir-Roman.svg#Avenir-Roman")); ?>') format("svg");
  font-weight: normal;
  font-style: normal;
  font-display: swap; }
...
<?php 
    list($r, $g, $b) = sscanf($data['hiddenFromData']['hexColor'], "#%02x%02x%02x");
?> 
    <div style="max-width: 736px;margin: 0px auto;color: #444444;" class="<?= $data['hiddenFromData']['font'] ?>">
            ...
            <div class="top-info">
              <div style="display: table;width: 100%;">
                ...
                <div style="display: table-cell;width: 50%;text-align:right;">
                    <p style="font-size: 30px;line-height: 1.4;margin: 0;" class="bold-txt"><?php echo e($data['data']['invoiceLabel']); ?></p>                    
                </div>
              </div>
              <div style="display: table;width: 100%;">
                <div style="display: table-cell;width: 184px;">
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['businessName']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['businessStreetAddress']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['businessCityStateZipCode']); ?></p>                                    
                </div>
                <div style="display: table-cell;width: 184px;">
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['businessNumber']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['businessEmail']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['website']); ?></p>
                </div>
                <div style="display: table-cell;width: 164px;margin-left: auto;">
                    <table style="width: 100%;">
                        <tbody>
                            <tr>
                                <td><label style="padding-right: 10px;font-size: 13px;" class="med-txt"><?php echo e($data['data']['invoiceNoLabel']); ?></label></td>
                                <td style="text-align: right;"><span style="font-size: 13px;"><?php echo e($data['data']['invoiceNo']); ?></span></td>
                            </tr>
                            <tr>
                                <td><label style="padding-right: 10px;font-size: 13px;" class="med-txt"><?php echo e($data['data']['invoiceDateLabel']); ?></label></td>
                                <td style="text-align: right;"><span style="font-size: 13px;"><?php echo e($data['hiddenFromData']['invoiceDate']); ?></span></td>
                            </tr>
                            <tr>
                                <td><label style="padding-right: 10px;font-size: 13px;" class="med-txt"><?php echo e($data['data']['invoiceDueDateLabel']); ?></label></td>
                                <td style="text-align: right;"><span style="font-size: 13px;"><?php echo e($data['hiddenFromData']['invoiceDueDate']); ?></span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
              ...
              <div style="margin-bottom: 15px;margin-top: 15px;">
                <div style="display: table;">
                    ...
                    <div style="padding: 0 10px 0 0;width: 184px;display: table-cell;">
                            <p style="font-size: 14px;margin: 0 0 6px;color: <?= $data['hiddenFromData']['hexColor'] ?>" class="bold-txt"><?php echo e($data['data']['billToLabel']); ?></p>
                            <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['billToClientName']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['billToMobileNumber']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['billToEmail']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['billToStreetAddress']); ?></p>
                    <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['billToCityStateZipCode']); ?></p>
                    </div>
                     <?php if($data['hiddenFromData']['shipToStatus'] == 'true'): ?>     
                    <div style="padding: 0 10px;width: 184px;display: table-cell;">
                        <h2 style="font-size: 14px;margin: 0 0 6px;color: <?= $data['hiddenFromData']['hexColor'] ?>" class="bold-txt"><?php echo e($data['data']['shipToLabel']); ?></h2>
                        <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['shipToClientName']); ?></p>
                        <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['shipToNumber']); ?></p>
                        <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['shipToEmail']); ?></p>
                        <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['shipToStreetAddress']); ?></p>
                        <p style="font-size: 13px;margin: 3px 0;"><?php echo e($data['data']['shipToCityStateZipCode']); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
              ...
              <div class="iv-table">
                <div class="table-responsive">
                  <table style="font-size:13px;width: 100%;border-collapse: collapse;">
                    <thead>
                      <tr>
                        <!-- <th width="20" style="border-bottom: 2px solid #2854c5;text-align: left;padding: 0.75rem;">ID</th> -->
                        <th style="background: <?= $data['hiddenFromData']['hexColor'] ?>;text-align: left;padding: 0.75rem;color: #fff;border: 1px solid #ededed;" class="med-txt"><?php echo e($data['data']['descriptionLabel']); ?></th>
                        <th style="background: <?= $data['hiddenFromData']['hexColor'] ?>;text-align: left;padding: 0.75rem;color: #fff;border: 1px solid #ededed;" class="med-txt"><?php echo e($data['data']['qtyLabel']); ?></th>
                        <th style="background: <?= $data['hiddenFromData']['hexColor'] ?>;text-align: left;padding: 0.75rem;color: #fff;border: 1px solid #ededed;" class="med-txt"><?php echo e($data['data']['priceLabel']); ?></th>
                        <th style="background: <?= $data['hiddenFromData']['hexColor'] ?>;text-align: left;padding: 0.75rem;color: #fff;border: 1px solid #ededed;" class="med-txt"><?php echo e($data['data']['amountLabel']); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>                        
                        <td style="border: 1px solid #ededed;padding: .75rem;">
              ...
              <div style="display: table;width: 100%;margin-top: 20px;">
                <div style="display: table-cell;">
                  <?php if(isset($data['data']['note'])): ?>
                    <h2 style="font-size: 14px;margin: 0 0 10px;" class="bold-txt"><?php echo e($data['data']['noteLabel']); ?></h2>
                    ...
                    <table class="total-sec" style="width: 100%;margin-left: auto;border-collapse: collapse;">
                        <tbody>
                          <?php if(isset($data['hiddenFromData']['subTotal'])): ?>
                            <tr>
                                <td class="med-txt" style="padding: 3px 15px 12px;font-size: 14px;border: 1px solid #ededed;"><?php echo e($data['data']['subTotalLabel']); ?></td>
                                <td style="text-align: right;font-size: 13px;padding-right: 18px;border: 1px solid #ededed;"><?php if( $data['hiddenFromData']['subTotal'] == 0){ echo '0.0'; } else { echo $data['hiddenFromData']['subTotal'];  } ?></td>
                            </tr>                           
                            <?php endif; ?>

                            <?php if($data['hiddenFromData']['GSTFiled']): ?>
                            <tr>
                                <td class="med-txt" style="padding: 3px 15px 12px;font-size: 14px;border: 1px solid #ededed;"><?php echo e($data['data']['salesLabel']); ?></td>
                                <td style="text-align: right;font-size: 13px;padding: 3px 15px 12px;border: 1px solid #ededed;"><?php echo e($data['data']['salesTax']); ?></td>
                            </tr>
                            <?php endif; ?>

                            <?php if($data['hiddenFromData']['othersTaxField']): ?>
                            <tr>
                                <td class="med-txt" style="padding: 3px 15px 12px;font-size: 14px;border: 1px solid #ededed;"><?php echo e($data['data']['othersTaxLabel']); ?></td>
                                <td style="text-align: right;font-size: 13px;padding: 3px 15px 12px;border: 1px solid #ededed;"><?php echo e($data['data']['othersTax']); ?></td>
                            </tr>
                            <?php endif; ?>

                            <?php if($data['hiddenFromData']['shippingField']): ?>
                            <tr>
                                <td class="med-txt" style="padding: 3px 15px 12px;font-size: 14px;border: 1px solid #ededed;"><?php echo e($data['data']['shippingLabel']); ?></td>
                                <td style="text-align: right;font-size: 13px;padding: 3px 15px 12px;border: 1px solid #ededed;"><?php echo e($data['data']['shipping']); ?></td>
                            </tr>
                            <?php endif; ?>

                            <?php if($data['hiddenFromData']['discountField']): ?>
                            <tr>
                              <td class="med-txt" style="padding: 3px 15px 12px;font-size: 14px;border: 1px solid #ededed;"><?php echo e($data['data']['discountLabel']); ?></td>
                              <td style="text-align: right;font-size: 13px;padding: 3px 15px 12px;border: 1px solid #ededed;"><?php echo e($data['data']['discount']); ?></td>
                            </tr>
                            <?php endif; ?>

                            <?php //dd($data['hiddenFromData']['hexColor']) ?>
                            <tr style="background-color: rgba( <?= $r ?>, <?= $g ?>,<?= $b ?>, 1);">
                                <td style="padding: 3px 15px 12px;font-size: 14px;border: 1px solid #ededed;color: #fff;" class="med-txt"><?php echo e($data['data']['totalLabel']); ?></td>
                                <td style="padding: 3px 15px 12px;text-align: right;font-size: 14px;border: 1px solid #ededed;color: #fff;" class="med-txt"><?php echo e($data['data']['currencySymbol']); ?> <?php echo e($data['hiddenFromData']['totalAmount']); ?></td>
                            </tr>
...
<?php /**PATH /var/www/invoice/resources/views/pdf-templates/template-3.blade.php ENDPATH**/ ?>